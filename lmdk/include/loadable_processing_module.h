...
#define DEFINE_MODULE_PACKAGE_ENTRY_POINT(MODULE) \
    ...
    int MODULE_PACKAGE_ENTRY_POINT_NAME(MODULE)(void *mod_cfg, void *parent_ppl, void **mod_ptr, void **mod_ops, void **mod_uuid) \
    { \
        ...
        return loadable_module_main(mod_cfg, parent_ppl, mod_ptr, mod_ops, mod_uuid); \
    }
